...
def log_valid(interarrival_seqs, event_types_seqs, length_seqs, device):
    ...
    sim_diffs_seqs, sim_times_index, total_duration_seqs = utils.generate_simulation(interarrival_seqs, length_seqs)
...
if __name__ == "__main__":
    ...
    for i in range(num_epochs):
        ...
        for idx, batch in enumerate(train_data):    
            ...
            # Generate simulation
            sim_diffs_seqs, sim_times_index, total_duration_seqs = utils.generate_simulation(interarrival_batch, length_seqs_batch)
            ...
            loss = model.train_batch(interarrival_batch, event_types_batch, sim_diffs_seqs, total_duration_seqs, length_seqs_batch, sim_times_index)
